...
public class Withdraw {
    public static void withdrawCash() throws IOException
    {
        ...
        System.out.println("\nChoose an option. For Example [1]\n");
    ...
    public static void option() throws IOException {
        ...
        int remindCash;
        String currentCash = com.fahriddin.Account.client.get(3);
        ...
        switch (option) {
            case 1 -> {
                ...
                if (remindCash > 0) {
                    ...
                    com.fahriddin.Account.client.add(remindCashStr);
                    com.fahriddin.Paper.paper();
                } else {
                    lack();
                }
            }
            ...
            default -> com.fahriddin.Handle.error();
        }
    }

    public static void showBalance()
    {
        System.out.println("\nYour Balance: " + com.fahriddin.Account.client.get(3));
    }
